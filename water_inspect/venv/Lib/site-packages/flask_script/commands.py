...
class Command(object):
    ...
    def __init__(self, func=None):
        ...
        # first arg is always "utils" : ignore
    ...
    def __call__(self, app=None, *args, **kwargs):
        """
        Handles the command with the given utils.
...
class Shell(Command):
    ...
    :param make_context: a callable returning a dict of variables
                         ...
                         returns a dict consisting of just the utils.
...
class Server(Command):
    """
    Runs the Flask development server i.e. utils.run()
    ...
    help = description = 'Runs the Flask development server i.e. utils.run()'
