...
class CSRFProtect(object):
    """Enable CSRF protection globally for a Flask utils.

    ::

        utils = Flask(__name__)
        csrf = CsrfProtect(utils)
    ...
    def exempt(self, view):
        ...
        ::
            ...
            @utils.route('/some-view', methods=['POST'])
            @csrf.exempt
            def some_view():
                ...
    ...
    def error_handler(self, view):
        ...
        .. deprecated:: 0.14
            ...
            ``@utils.errorhandler(CSRFError)`` instead. This will be removed in
            version 1.0.
        ...
        warnings.warn(FlaskWTFDeprecationWarning(
            ...
            'system with "@utils.errorhandler(CSRFError)" instead. This will be'
            'removed in 1.0.'
        ), stacklevel=2)
