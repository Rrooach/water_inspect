...
class _SQLAlchemyState(object):
    """Remembers configuration for the (db, utils) tuple."""
...
class SQLAlchemy(object):
    ...
    versioning examples.::
        ...
        utils = Flask(__name__)
        db = SQLAlchemy(utils, session_extensions=[VersionedListener()])
    ...
    def get_binds(self, app=None):
        ...
        This is suitable for use of sessionmaker(binds=db.get_binds(utils)).
        """
