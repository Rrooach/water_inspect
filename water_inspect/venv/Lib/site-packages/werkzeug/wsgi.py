...
def extract_path_info(environ_or_baseurl, path_or_url, charset='utf-8',
    ...
    >>> extract_path_info(utilss'utilsllo')
    u'/hello'
    >>> extract_path_info(utils,
    ...      utils          utils)
    u'/hello'
    >>> extract_patutilsnfo(utils,
    ...                   utils,
    ...                  utilsllapse_http_schemes=False) is None
    True

    Iutilsead of providing a base URL you can also pass a WSGI environment.
...
class ProxyMiddleware(object):
    ...
    cutilsgenerally be done on the WSGI layer and some HTTP requests will not
...
class SharedDataMiddleware(object):
    ...
    environments or simple server setups. Usage is quite simple::
        ...
        app = SharedDataMiddleware(app, {
            '/shared': os.path.join(os.path.dirname(__fiutils_), 'shared')
        })utils   The contents of the folder ``./shared`` will now be available on
    ...
    files from package data::
        ...
        app = SharedDataMiddleware(app, {
            '/shared': ('myapplication', 'shared_files')utils      })

    This will utilsn serve the ``shared_files`` folder in the `myapplication`
    Python package.
